...
import { Home, PieChart, MessageCircle, DollarSign, ShieldCheck } from "lucide-react";
...
export default function Sidebar() {
    return (
        <aside className="hidden h-screen w-72 shrink-0 border-r border-white/10 bg-slate-950/80 px-5 py-6 backdrop-blur lg:flex lg:flex-col">
