            ...
            <motion.div variants={gridMotion} initial="hidden" animate="show" className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                <motion.div variants={itemMotion}>
                    <Card className="relative overflow-hidden">
                        <div className="text-xs font-semibold uppercase tracking-[0.3em] text-slate-500">Balance</div>
                        <div className="mt-3 text-3xl font-semibold text-white">₹ 1,23,456</div>
                        <div className="mt-1 text-sm text-emerald-400">+3.2% since last month</div>
                    </Card>
                </motion.div>
                <motion.div variants={itemMotion}>
                    <Card className="relative overflow-hidden">
                        <div className="text-xs font-semibold uppercase tracking-[0.3em] text-slate-500">Savings rate</div>
                ...
                <motion.div variants={itemMotion}>
                    <Card className="relative overflow-hidden">
                        <div className="text-xs font-semibold uppercase tracking-[0.3em] text-slate-500">Burn rate</div>
                ...
                <motion.div variants={itemMotion}>
                    <Card className="relative overflow-hidden">
                        <div className="text-xs font-semibold uppercase tracking-[0.3em] text-slate-500">Runway</div>
                ...
                <motion.div variants={itemMotion} className="lg:col-span-2">
                    <Card>
                        <div className="flex items-start justify-between gap-4">
                            <div>
                                <div className="text-sm font-semibold text-white">Monthly cashflow</div>
